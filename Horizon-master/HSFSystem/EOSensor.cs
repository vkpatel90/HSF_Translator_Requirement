...
namespace HSFSubsystem
{
    public class EOSensor : Subsystem
    {
        ...
        protected StateVarKey<bool> IMGQTY_KEY; //I ADDED THIS
        ...
        public EOSensor(XmlNode EOSensorXmlNode, Dependency dependencies, Asset asset)
        {
            ...
            IMGQTY_KEY = new StateVarKey<bool>(Asset.Name + "." + "numImgCapture"); //I ADDED THIS
            addKey(PIXELS_KEY);
            addKey(INCIDENCE_KEY);
            addKey(EOON_KEY);
            addKey(IMGQTY_KEY); //I ADDED THIS
        ...
        public override bool CanPerform(Event proposedEvent, Universe environment)
        {
            ...
            if (_task.Type == TaskType.IMAGING)
            {
                ...
                _newState.AddValue(IMGQTY_KEY, new KeyValuePair<double, bool>(ts, true)); //I ADDED THIS
                //_newState.AddValue(IMGQTY_KEY, new KeyValuePair<double, double>(timage + 1, 0.0)); //I ADDED THIS
