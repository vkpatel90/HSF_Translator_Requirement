...
namespace HSFSubsystem
{
    public class SSDR : Subsystem
    {
        ...
        //protected StateVarKey<double> TOTALDATA_KEY; //I ADDED THIS
        ...
        public SSDR(XmlNode SSDRXmlNode, Dependency dependencies, Asset asset)
        {
            ...
            //TOTALDATA_KEY = new StateVarKey<double>(Asset.Name + "." + "totaldata"); //I ADDED THIS
            //addKey(TOTALDATA_KEY); //I ADDED THIS
        ...
        public override bool CanPerform(Event proposedEvent, Universe environment)
        {
            ...
            if (_task.Type == TaskType.IMAGING)
            {
                ...
                //NEED TO GET DATA VALUE AT THIS POINT?
                if (!exceeded)
                {
                    _newState.AddValue(DATABUFFERRATIO_KEY, newdataratio);
                    //_newState.AddValue(TOTALDATA_KEY, newtotaldata); // I ADDED THIS
                    return true;
                }
